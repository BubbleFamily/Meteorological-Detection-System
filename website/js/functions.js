    ...
    var settings =  '<a id="settings" href="#changeSkin" data-toggle="modal">' +
			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-header">' +
				    ...
				    '<h4 class="modal-title">改变模板皮肤</h4>' +
				'</div>' +
				'<div class="modal-body">' +
				    '<div class="row template-skins">' +
					'<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-violate.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-violate.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-lights.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-lights.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-city.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-city.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-greenish.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-greenish.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-night.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-night.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-blue.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-blue.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-sunny.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-sunny.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-cloth.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-cloth.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-tectile.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-tectile.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-chrome.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-chrome.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-ocean.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-ocean.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-sunset.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-sunset.jpg*/ alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-yellow.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-yellow.jpg*/ alt="">' +
					'</a>' +
					'<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4" href="">' +
					    '<img class="img_list" src="skin-kiwi.jpg"/*tpa=http://112.25.190.109:7002/eaps/js/img/skin-kiwi.jpg*/ alt="">' +
					'</a>' +
				    '</div>' +
				'</div>' +
			    '</div>' +
